...
Email outreach, email lsits of students work well with incentive, many said it sounds fun, none had an issue with signing agreement, as most were academics themselves they were interested in the study results, Guided access feature is perfect for this as it also memorizes the duration per app - perfect for our 2min baseline and 25min scroll.
Challenges were staying strict with what to say to them, how to brief what to do when stops, and when what.

\section{The Reusable Methodological Pipeline} \label{sec:results_pipeline}

Can be accessed on github, and was observed to run mostly smoothly with some bluetooth dropouts, still unstructured, can be more structured.
The development process caused us to have roughly 80 percent dead wight scripts that were only temporary or superseeded by a newer script - a simple cleaning algorith shall be implemented next time.
...
Observation X, see Figure~\ref{fig:cohend_interactions}
...
Observation X, see Figure~\ref{fig:cohend_top_features_2}
...
\subsection{Alternative Index Exploration} \label{sec:results_alternative_index}
...
\section{Neuroscientific and Psychological Interpretation}
