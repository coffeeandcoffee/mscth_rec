...
F1 Train (SKIP) & 49.6\% & \textcolor{green}{20.6\%} & TRUE \\\\
F1 Test (SKIP) & 48.9\% & \textcolor{green}{10.7\%} & TRUE \\\\
Precision (SKIP) & 49.9\% & \textcolor{green}{23.5\%} & TRUE \\\\
Recall (SKIP) & 48.0\% & \textcolor{green}{9.6\%} & TRUE \\\\
\hline
\end{tabular}
