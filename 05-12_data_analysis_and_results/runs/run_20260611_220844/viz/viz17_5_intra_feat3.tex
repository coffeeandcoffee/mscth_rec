...
Metric & EI LR & \multicolumn{2}{c}{TP10 raw std} \\\\
 & Val & Val & Sig \\\\
\hline
F1 Train (STAY) & 53.8\% & \textcolor{green}{52.4\%} & TRUE \\\\
F1 Test (STAY) & 50.9\% & \textcolor{green}{49.3\%} & TRUE \\\\
Precision (STAY) & 49.1\% & \textcolor{green}{48.2\%} & TRUE \\\\
Recall (STAY) & 52.9\% & \textcolor{green}{50.4\%} & TRUE \\\\
F1 Train (SKIP) & 49.6\% & \textcolor{green}{52.6\%} & TRUE \\\\
F1 Test (SKIP) & 46.9\% & 46.8\% & FALSE \\\\
Precision (SKIP) & 48.9\% & \textcolor{green}{47.9\%} & TRUE \\\\
